...
export default {
  ...
  data() {
    return {
      ...
      isActive3: false,
      isActive4: false,
      src1: require("../assets/img/portfolio/img3.jpg"),
      src2: require("../assets/img/portfolio/img2.jpg"),
      src3: require("../assets/img/portfolio/img5.jpg"),
      src4: require("../assets/img/portfolio/img7.jpg"),
      popup1: require("../assets/img/portfolio/img3.jpg"),
      popup2: require("../assets/img/portfolio/img2.jpg"),
      popup3: require("../assets/img/portfolio/img5.jpg"),
      popup4: require("../assets/img/portfolio/img7.jpg"),
